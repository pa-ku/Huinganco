    ...
    <form action="" className="form" id="form-consul">
        <div className="ctn-form">
            <div className="ctn-input">
                <input type="text" placeholder="Nombre" className="form-input email-consul" required pattern="[a-zA-Z]{2,}"
                    id="nombre"/>

                <input type="text" placeholder="eMail" className="form-input " id="email-consul"
            ...
            <textarea name="" className="textarea" cols="100%" rows="100%" placeholder="hay bandurrias?" required
