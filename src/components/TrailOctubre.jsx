            ...
            <div className="carousel" data-carousel>
                ...
                <ul data-slides>
                    ...
                    <li className="slide" data-active>
                        ...
                        <img loading="lazy" width=" 200px" height="200px" src={imgCarousell} alt=""/>
                    </li>

                    <li className="slide">
                        <img loading="lazy" width=" 200px" height="200px" src={imgCarousel2} alt=""/>
                    </li>


                    <li className="slide">
                        <img loading="lazy" width=" 200px" height="200px" src={imgCarousel3} alt=""/>
                    </li>
...
{/*         <!-- FIN CAROUSEL --> */}
        ...
        <div className="octubre-huignanco">
            ...
            <p className="octubre-text"> El 10 de octubre, el norte neuquino recibe a la destacada prueba. Incluye los 50
            ...
            <a href="#" className="btn-banner">Conocé más</a>
            <a href="/reserva/reservaIndex.html" className="btn-banner" id="btn-reserva" target="_blank">Reserva tu
                lugar!</a>
