...
<nav className="nav">
    ...
    <div className="ctn-bt-theme">
        <label htmlFor="theme" className="label-theme" title="theme">
            <input type="checkbox" value="theme" className="theme" id="switchTheme"/>
    ...
    <a href="#" className="btn-nav">Que hacer</a>
    <a href="#" className="btn-nav">Informacion</a>
    <a href="#" className="btn-nav">Temporadas</a>
    <a href="#" className="btn-nav">Noticias</a>   
</nav>
...
<div className="dropdown">
    ...
    <label htmlFor="dropdown-mobile" className="label-dropdown-mobile2"></label>
    ...
    <div className="dropdown-menu">
        <a href="#" className="btn-menu-dropdown">Que Hacer </a>
        <a href="#" className="btn-menu-dropdown">Información </a>
        <a href="#" className="btn-menu-dropdown">Temporadas </a>
        <a href="#" className="btn-menu-dropdown">Noticias </a>     
    </div>
</div>
